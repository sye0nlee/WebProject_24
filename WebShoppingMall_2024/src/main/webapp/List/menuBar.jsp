...
<body>
	...
	<div class="w3-bar w3-yellow">
		...
		<div>
			<c:choose>
				<c:when test="${ user_id == null }">
					...
					<a href="streetWear.jsp"
						class="w3-bar-item w3-button w3-hover-white">Street-Wear</a>
				...
				<c:otherwise>
					<a href="index.jsp?user_id=${user_id}"
						class="w3-bar-item w3-button w3-hover-white">Main</a>
					<a href="streetWear.jsp?user_id=${user_id}"
						class="w3-bar-item w3-button w3-hover-white">Street-Wear</a>
					<a href="#" class="w3-bar-item w3-button w3-hover-white">Young-Casual</a>
					<a href="#" class="w3-bar-item w3-button w3-hover-white">Accessory</a>
					<a href="mypage.jsp?user_id=${user_id}"
						class="w3-bar-item w3-button w3-hover-white">My-Page</a>
				</c:otherwise>
			</c:choose>
		</div>
		...
		<div style="position: fixed; right: 20px; bottom: 20px;">
			...
			<c:if test="${ user_id != null}">
				<a href="mypage.jsp" class="w3-bar-item w3-button w3-hover-white"><%= user_id %>
					님 </a>
				<a
					onclick="javascript:alert('로그아웃 되었습니다.'); location.href = 'index.jsp?logout=1'"
					href="index.jsp" class="w3-bar-item w3-button w3-hover-white">로그아웃</a>
